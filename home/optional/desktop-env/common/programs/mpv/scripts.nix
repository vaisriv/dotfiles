{
    ...
    home = {
        ...
        file = {
            # ani-skip mpv script (https://github.com/synacktraa/ani-skip)
            ani-skip = {
                enable = false;

                target = ".config/mpv/scripts/ani-skip/skip.lua";
                text =
                    # lua
                    ''
            ...
            # autochapters mpv script (https://github.com/po5/mpv-auto-chapters)
            autochapters = {
                enable = true;

                target = ".config/mpv/scripts/autochapters/main.lua";
                text =
                    # lua
                    ''
                        -- autochapters
