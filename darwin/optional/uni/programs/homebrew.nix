{
    ...
    homebrew = {
        ...
        casks = [
            ...
            # julia is broken on nix bc of fhs env. want to eventually be handled by nix need to figure out shell.nix/flake.nix fhs-env or similar to get packages/libraries to actually work and not have linking errors
            "julia"
